...
export default function PropertyMetaDialog({
  isOpen,
  onToggleOpen,
  elementDefinition,
}: PropertyMetaDialogProps) {
    ...
    >
      ...
      <DialogContent sx={{ padding: 0, margin: 0 }}>
        ...
        {selectedTabIndex === 0 && (
          <Box sx={{ padding: "0 15px" }}>
            ...
            <Box sx={{ color: "secondary.main" }}>
              {elementDefinition.type?.map((t) => t.code).join(", ")}
            </Box>
        ...
        {selectedTabIndex === 1 && (
          <Box
            component="pre"
            sx={{ padding: "5px", margin: 0, background: "rgb(240,240,240)" }}
          >
