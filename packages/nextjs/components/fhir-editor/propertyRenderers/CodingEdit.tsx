...
export default function CodeableConcept({ initCoding, onConfirmCoding, onCancel, isUpdating }: CodeableConceptProps) {
  ...
  return (
    ...
    >
      ...
      <Button onClick={onAddCode} size="small" variant="contained" sx={{ marginTop: "5px", textTransform: "none" }}>
        {isUpdating ? "Update Code" : "Create Code"}
      </Button>

      <Button onClick={onCancel} size="small" sx={{ marginTop: "5px", marginLeft: "5px", textTransform: "none" }}>
        Cancel
      </Button>
    </Box>
  );
